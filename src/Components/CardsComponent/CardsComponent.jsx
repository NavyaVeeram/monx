...
const CardsComponent = () => {
  ...
  return (
    ...
    >
     <Link as={Link} to='/gallerybang' className='text-light text-decoration-none'>Explore</Link>
   ...
   <div className="col-md-4 mb-4">
      ...
      onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'red'}
    >
     <Link as={Link} to='/gallerysak' className='text-light text-decoration-none'>Explore</Link>
      ...
      onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'red'}
    >
     <Link as={Link} to='/galleryram' className='text-light text-decoration-none'>Explore</Link>
